...
const SearchOrdersTable: FC<{}> = () => {
  ...
  return (
    <Container p="0" maxW="100%" bg="white">
      <TableControls fetchNext={fetchNext} fetchPrev={fetchPrev} showSearch={showSearch} />
      <Box
        ref={currentRef}
        alignItems="stretch"
        overflowX="auto"
      ...
      >
        <Query loading={loading} error={undefined} data={undefined}>
          <Table height={size.height} width={size.width} />
        </Query>
      </Box>
    </Container>
  );
